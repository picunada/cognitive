...
from cognitive.api.v1.views import user, organization, transaction, statistic
...
urlpatterns = [
    ...
    path('api/v1/statistic/', statistic.Statistic.as_view(), name='statistic'),
